...
(defvar plover-font-lock-keywords
  (eval-when-compile
    (list
     ...
     ;;  )
     '("\\_<\\(?:import\\|extern\\|static\\|inline\\|struct\\|vec\\|mat\\|for\\|sum\\|in\\|out\\|inout\\|if\\|then\\|else\\|True\\|False\\|Void\\|T\\|_\\|and\\|or\\|not\\|storing\\|assert\\|return\\)\\_>" . font-lock-keyword-face)
...
;     '("\\_<\\(?::\\(?:\\s_\\|\\sw\\)+\\)\\_>" 0 font-lock-constant-face)
     ...
     '("\\_<\\(?:u8\\|s8\\|u16\\|s16\\|u32\\|s32\\|u64\\|s64\\|float\\|double\\|string\\|bool\\|Diagonal\\|UpperTriangular\\|LowerTriangular\\|Dense\\|Symmetric\\)\\_>" . font-lock-type-face)
